...
class QueryRequest(BaseModel):
    ...
    top_k: int = Field(8, ge=1, le=20, description="Number of passages to retrieve.")
    alpha: float = Field(0.7, ge=0.0, le=1.0, description="Hybrid retriever weighting factor.")
